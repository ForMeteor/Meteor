  ...
  mounted () {
    ...
    class ListScroll {
      ...
      topItemCb (entry) {
        ...
        if (
          currentY > topSentinelPreviousY && isIntersecting && currentRatio >= topSentinelPreviousRatio
        ) {
      ...
      bottomItemCb (entry) {
        ...
        // 下滑精准判定 => TODO 更深入明确理解
        if (
          currentY < bottomSentinelPreviousY && currentRatio >= bottomSentinelPreviousRatio && isIntersecting
        ) {
